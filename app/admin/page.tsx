  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-start p-8 bg-gray-100 relative">
      ...
      <button
        ...
        aria-label="Create"
      >
        <FaPlus size={20} className="md:text-xl" />
      </button>
      {showModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center overflow-auto">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg w-full max-w-xs sm:max-w-sm md:max-w-lg lg:max-w-5xl max-h-[90vh] overflow-auto">
            ...
            <textarea
              ...
              placeholder="Content"
              className="w-full p-4 mb-4 border rounded h-50 resize-none"
            />
